 ...
 */
{
...

    {
        ...
        // let {PlanningIntention} = require('../pddl/BlackboxIntentionGenerator')([PickUp, PutDown, Stack, nStack])
        ...
        a1.postSubGoal( new PlanningGoal( { goal: ['on-table b'] } ) ) // by default give up after trying all intention to achieve the goal
    }
    /**
     * 
